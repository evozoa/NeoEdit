...
**No Python needed.** Get the installer for your computer from the
[latest release](https://github.com/evozoa/NeoEdit/releases/latest):
...
gene naming for ORFs, signed/notarized installers.
